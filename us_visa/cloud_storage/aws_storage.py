...
class SimpleStorageService:
    ...
    def read_object(object_name: str, decode: bool = True, make_readable: bool = False) -> Union[StringIO]:
        ...
        try:
            ...
            logging.info("Exitied the read_object method of S3Operations class")
            return conv_func
    ...
    def get_bucket(self, bucket_name: str) -> Bucket:
        """
        Method Name: get bucket
        Description: This method gets the bucket object based on th ebucket_name

        Ouput: Bucket object is returned based on the bucket name
        On Failure: Write an exception log and then raise an exception
        """
        logging.info("Entered the get bucket method of S3Operations class")
    ...
    def get_file_object(self, filename: str, bucket_name: str)-> Union[List[object], object]:
        ...
        Revisions: moved setup to cloud
        """
        logging.info("Entered the get_fileobject method of S3Operations class")
        try:
            bucket = self.get_bucket(bucket_name)
